...
import com.thinkingdata.analytics.android.plugin.ThinkingAnalyticsPlugin
...
class TimeTrace implements TaskExecutionListener, BuildListener {
    ...
    void buildFinished(BuildResult result) {
        LoggerFactory.getLogger(ThinkingAnalyticsPlugin).debug("Tasks spend time > ${DISPLAY_TIME_THRESHOLD}ms:")
