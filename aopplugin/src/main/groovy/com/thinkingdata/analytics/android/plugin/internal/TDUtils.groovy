 ...
 */
package com.thinkingdata.analytics.android.plugin.internal
...
class TDUtils {
    ...
    static void doWorkWithNoAspectj(TransformInvocation transformInvocation) {
        LoggerFactory.getLogger(ThinkingAnalyticsExtension).debug("do nothing ~~~~~~~~~~~~~~~~~~~~~~~~")
    ...
    static void fullCopyFiles(TransformInvocation transformInvocation) {
        ...
        transformInvocation.inputs.each { TransformInput input ->
            input.directoryInputs.each { DirectoryInput dirInput->
                ...
                TDUtils.mergeJar(dirInput.file, excludeJar)
            }
