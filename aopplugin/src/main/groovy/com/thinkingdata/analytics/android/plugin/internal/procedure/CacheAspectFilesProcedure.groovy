 ...
 * @since 2018-04-23
 */
class CacheAspectFilesProcedure extends AbstractProcedure {
...
//                    collect aspect file
                batchTaskScheduler.addTask(new ITask() {
                    ...
                    Object call() throws Exception {
                        ...
                        while (entries.hasMoreElements()) {
                            ...
                            if (!jarEntry.isDirectory() && TDUtils.isClassFile(entryName)) {
                                ...
                                if (TDUtils.isAspectClass(bytes)) {
        ...
        if (TDUtils.countOfFiles(variantCache.aspectDir) == 0) {
