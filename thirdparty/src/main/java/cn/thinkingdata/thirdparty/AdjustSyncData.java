    ...
    public void syncThirdPartyData() {
        ...
        try {
            ...
            addSessionParameterMethod
                    .invoke(null, TAThirdConstants.TA_DISTINCT_ID, distinctId == null ? "" : distinctId);
            addSessionParameterMethod
                    .invoke(null, TAThirdConstants.TA_ACCOUNT_ID, accountId == null ? "" : accountId);
            TDLog.d(TAG, "Adjust数据同步成功");
        } catch (Exception e) {
