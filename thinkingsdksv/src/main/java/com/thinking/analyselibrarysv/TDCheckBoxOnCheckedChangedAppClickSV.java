...
public class TDCheckBoxOnCheckedChangedAppClickSV {
    private final static String TAG = "TDCheckBoxOnCheckedChangedAppClickSV";
    ...
    public static void onAppClick(JoinPoint joinPoint) {
        try {
            ...
            if (view instanceof CheckBox) { // CheckBox
                properties.put(AopConstantsSV.ELEMENT_TYPE, "CheckBox");
                CompoundButton compoundButton = (CompoundButton) view;
                if (!TextUtils.isEmpty(compoundButton.getText())) {
                    viewText = compoundButton.getText().toString();
                }
            } else if (view instanceof SwitchCompat) {
                properties.put(AopConstantsSV.ELEMENT_TYPE, "SwitchCompat");
                ...
                properties.put(AopConstantsSV.ELEMENT_TYPE, "ToggleButton");
                ...
                properties.put(AopConstantsSV.ELEMENT_TYPE, "RadioButton");
            ...
            e.printStackTrace();
            TDLogSV.i(TAG, " onCheckedChanged AOP ERROR: " + e.getMessage());
        }
    }
}
