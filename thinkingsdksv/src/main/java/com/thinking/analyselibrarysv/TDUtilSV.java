...
import static com.thinking.analyselibrarysv.ThinkingAnalyticsSDKSV.VERSION;

public class TDUtilSV {
    private static final String TAG = "TD.TDUtilSV";
    ...
    public static boolean checkHasPermission(Context context, String permission) {
        try {
            ...
            if (packageManager == null || packageName == null) {
                TDLogSV.d(TAG, "Can't check configuration when using a Context with null packageManager or packageName");
                return false;
            }

            if (PackageManager.PERMISSION_GRANTED != packageManager
                    .checkPermission(permission, packageName)) {
                TDLogSV.d(TAG, "You can fix this by adding the following to your AndroidManifest.xml file:\n"
    ...
    public static Map<String, Object> getDeviceInfo(Context mContext)
    {
        final Map<String, Object> deviceInfo = new HashMap<String, Object>();
        {
            ...
            if (TDUtilSV.checkHasPermission(mContext, "android.permission.READ_PHONE_STATE")) {
                try {
                    ...
                    if (!TextUtils.isEmpty(operatorString)) {
                        deviceInfo.put("#carrier", TDUtilSV.operatorToCarrier(operatorString));
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    static String getVersionName(Context mContext) {
        ...
        try {
            ...
            TDLogSV.d(TAG, "Exception getting app version");
        }
        return version;
    }
