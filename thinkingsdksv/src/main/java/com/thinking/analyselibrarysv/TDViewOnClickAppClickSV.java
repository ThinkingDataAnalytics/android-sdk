...
public class TDViewOnClickAppClickSV {
    private final static String TAG = "TDViewOnClickAppClickSV";
    ...
    public static void onAppClick(JoinPoint joinPoint) {
        try {
            ...
            if (method != null) {
                ThinkingDataIgnoreTrackOnClickSV trackEvent = method.getAnnotation(ThinkingDataIgnoreTrackOnClickSV.class);
                if (trackEvent != null) {
                    return;
                }
            }
...
//                        return;
            ...
            e.printStackTrace();
            TDLogSV.i(TAG, "onViewClickMethod error: " + e.getMessage());
        }
    }
}
