...
import webbrowser
isExit = False;
androidSDKPath = '/Users/halewang/Desktop/SDk/android-sdk';
...
def AndroidUnitTest():
    ...
    os.system('pwd')
    os.system('./gradlew thinkingsdk:connectedAndroidTest')
    webbrowser.open_new_tab('file:///'+androidSDKPath+'/thinkingsdk/build/reports/androidTests/connected/index.html')
    print('***************安卓单元测试结束***************')
