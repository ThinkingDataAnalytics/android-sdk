...
//        setUp();
    ...
    public static void initThinkingDataSDK(Context context) {
        ...
        TDConfig config1 = TDConfig.getInstance(mContext,TA_APP_ID,"https://receiver.ta.thinkingdata.test/","debugname");
        config1.setMode(TDConfig.ModeEnum.DEBUG);
...
//        config.setMode(TDConfig.ModeEnum.DEBUG);
        ...
        ThinkingAnalyticsSDK mInstance1 = ThinkingAnalyticsSDK.sharedInstance(config1);
        mInstance.setTrackStatus(ThinkingAnalyticsSDK.TATrackStatus.NORMAL);
